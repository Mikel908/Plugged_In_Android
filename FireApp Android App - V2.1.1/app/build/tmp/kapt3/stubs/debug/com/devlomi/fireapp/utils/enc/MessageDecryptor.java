...
public final class MessageDecryptor {
    ...
    kotlin.coroutines.Continuation<? super com.devlomi.fireapp.model.realms.Message> p2) {
        return null;
    }
    
    private final java.lang.Object decryptContent(com.devlomi.fireapp.model.realms.Message message, kotlin.coroutines.Continuation<? super java.lang.String> p1) {
        return null;
    }
    
    private final java.lang.Object decryptPartialText(com.devlomi.fireapp.model.realms.Message message, kotlin.coroutines.Continuation<? super java.lang.String> p1) {
        return null;
    }
    
    private final java.lang.Object decryptContact(com.devlomi.fireapp.model.realms.Message message, kotlin.coroutines.Continuation<? super com.devlomi.fireapp.model.realms.RealmContact> p1) {
        return null;
    }
    
    private final java.lang.Object decryptThumb(com.devlomi.fireapp.model.realms.Message message, kotlin.coroutines.Continuation<? super java.lang.String> p1) {
        return null;
    }
    
    private final java.lang.Object decryptLocation(com.devlomi.fireapp.model.realms.Message message, kotlin.coroutines.Continuation<? super com.devlomi.fireapp.model.realms.RealmLocation> p1) {
        return null;
    }
}